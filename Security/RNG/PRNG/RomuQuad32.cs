...
#region Constructor &Destructor
    ...
    /// Z state.
    /// </param>
    public RomuQuad32(uint seed1 = 0, uint seed2 = 0, uint seed3 = 0,
                      uint seed4 = 0) {
      this._W = seed1;
      this._X = seed2;
      this._Y = seed3;
    ...
    /// Clear all seed.
    /// </summary>
    ~RomuQuad32() { this._W = this._X = this._Y = this._Z = 0; }
...
#region Public Method
    ...
    /// <inheritdoc/>
    public override string AlgorithmName() { return "Romu Quad 32 bit"; }
