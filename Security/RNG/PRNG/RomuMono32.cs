...
namespace Litdex.Security.RNG {
  ...
  /// numbers. Fixed period of (2^32)-47. Must be seeded using the
  /// romuMono32_init function. Capacity = 2^27 bytes. Register pressure = 2.
  /// State size = 32 bits.
  /// </summary>
...
#region Public Method
    ...
    /// <inheritdoc/>
    public override string AlgorithmName() { return "Romu Mono 32 bit"; }
